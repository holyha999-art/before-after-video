...
def process():
    ...
    before_path = os.path.join(UPLOAD, str(uuid.uuid4())+"_before.mp4")
    after_path = os.path.join(UPLOAD, str(uuid.uuid4())+"_after.mp4")

    before.save(before_path)
    after.save(after_path)

    output = os.path.join(UPLOAD,"result.mp4")
